 ...
 */
public class RowStripeJList
    extends javax.swing.JList
{

	private static final long serialVersionUID = 6609366174500643726L;
	private java.awt.Color rowColors[] = new java.awt.Color[2];
    private boolean drawStripes = false;
 
    public RowStripeJList( )
    {
    }
    public RowStripeJList( javax.swing.ListModel dataModel )
    {
        super( dataModel );
    }
    public RowStripeJList( Object[] listData )
    {
        super( listData );
    }
    public RowStripeJList( java.util.Vector<?> listData )
    {
        super( listData );
    }
